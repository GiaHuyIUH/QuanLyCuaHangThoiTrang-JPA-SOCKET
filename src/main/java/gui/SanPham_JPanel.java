...
public class SanPham_JPanel extends javax.swing.JPanel {
     ...
     * @throws Exception 
     */
    public SanPham_JPanel() throws RemoteException {
        initComponents();
        //Khởi tạo
        ...
        ImageIcon img_btnLamMoi = new ImageIcon("src//main//java//pic//icon//buttonLamMoi.png");
        ...
        ImageIcon img_btnThem = new ImageIcon("src//main//java//pic//icon//buttonThem.png");
        ...
        ImageIcon img_btnCapNhat = new ImageIcon("src//main//java//pic//icon//buttonCapNhat.png");
        ...
        ImageIcon img_btnKiemTraTonKho = new ImageIcon("src//main//java//pic//icon//buttonKiemTraTonKho.png");
        ...
        ImageIcon img_btnChonAnh = new ImageIcon("src//main//java//pic//icon//buttonChonAnh.png");
        ...
        ImageIcon img_lblAnh = new ImageIcon("src//main//java//pic//icon//labelAnh.png");
        ...
        ImageIcon img_btnNhapExcel = new ImageIcon("src//main//java//pic//icon//buttonNhapExcel.png");
        ...
        ImageIcon img_btnXuatExcel = new ImageIcon("src//main//java//pic//icon//buttonXuatExcel.png");
        ...
        ImageIcon img_btnLuu = new ImageIcon("src//main//java//pic//icon//buttonLuu.png");
...
//            String tenCTKM = ctkm_bus.layTenKhuyenMaiTheoMa(sp.getChuongTrinhKhuyenMai().getMaCTKM());
    ...
    private void btn_ChonAnhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ChonAnhActionPerformed
        JFileChooser fileChooser = new JFileChooser("src//main//java//pic//imageProduct");
        ...
        if (kq == JFileChooser.APPROVE_OPTION) {
            ...
            duongDanAnh = "src//main//java//pic//imageProduct//" + tenTepAnh;
    ...
    private void timKiemSanPham(String dieuKien) throws RemoteException {
        ...
        if (timKiem.isBlank()) {
            ...
            for (SanPhamEntity sp : dsSP) {
                ...
                String km ="";
				if (chuongTrinhKhuyenMai == null) {
					chuongTrinhKhuyenMai = new ChuongTrinhKhuyenMaiEntity();
				}else {
					km = ctkm_bus.layTenKhuyenMaiTheoMa(chuongTrinhKhuyenMai.getMaCTKM());
				}
//                = ctkm_bus.layTenKhuyenMaiTheoMa(chuongTrinhKhuyenMai.getMaCTKM());
                String hienThiKM = "";
                if (km != null) {
                    hienThiKM = km;
                } else {
...
//        cbo_ThuongHieu.setSelectedIndex(0);
        if (cbo_ThuongHieu.getItemCount() > 0) {
            // Ensure that the combo box has at least one item
            cbo_ThuongHieu.setSelectedIndex(0); // Set the selected index to the first item
        } 
...
//                            mauSac = MauSacEnum.GREY;
//                        }
                        if (cbo_MauSac.getSelectedItem() != null) {
                            // Tiếp tục xử lý
                            if (cbo_MauSac.getSelectedItem().equals("Trắng")) {
                                mauSac = MauSacEnum.WHITE;
                            } else if (cbo_MauSac.getSelectedItem().equals("Đen")) {
                                ...
                                // Xử lý trường hợp màu sắc không được nhận dạng
                                // Ví dụ: hiển thị thông báo lỗi
                                JOptionPane.showMessageDialog(null, "Màu sắc không được nhận dạng!");
                            }
                        }
...
//                        String tenThuongHieu = cbo_ThuongHieu.getSelectedItem().toString();
                        ...
                        Object selectedItem = cbo_ThuongHieu.getSelectedItem();
                        String tenThuongHieu = "";
                        if (selectedItem != null) {
                            tenThuongHieu = selectedItem.toString();
                        } else {
...
//                    System.out.println(f);
    ...
    private void kiemTraTonKho() throws RemoteException {
        ...
        DecimalFormat decimalFormat = new DecimalFormat();
        if(dsSP.isEmpty()) {
        	JOptionPane.showMessageDialog(null, "Tất cả sản phẩm đều còn hàng");
        }
//        for (SanPhamEntity sp : dsSP) {
//            String formattedDonGia = decimalFormat.format(sp.getDonGia()) + " VNĐ";
//            String tenChatLieu = chatLieu_bus.layTenChatLieuTheoMa(sp.getChatLieu().getMaChatLieu());
...
//        }
        for (SanPhamEntity sp : dsSP) {
            ...
            if (sp.getChuongTrinhKhuyenMai() != null) {
                String km = ctkm_bus.layTenKhuyenMaiTheoMa(sp.getChuongTrinhKhuyenMai().getMaCTKM());
                hienThiKM = (km != null) ? km : "Không giảm giá";
            } else {
                hienThiKM = "Không giảm giá";
            }
...
//        } else {
//            ImageIcon anhMacDinh = new ImageIcon("src//main//java//pic//icon//labelAnh.png");
