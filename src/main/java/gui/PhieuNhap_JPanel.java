...
public class PhieuNhap_JPanel extends javax.swing.JPanel {
    ...
    public PhieuNhap_JPanel() throws Exception {
        ...
        ImageIcon img_btn_NhapHang = new ImageIcon("src//main//java//pic//icon//buttonNhapHang.png");
        ...
        ImageIcon img_btn_CapNhat = new ImageIcon("src//main//java//pic//icon//buttonCapNhat.png");
        ...
        ImageIcon img_btn_NhapExcel = new ImageIcon("src//main//java//pic//icon//buttonNhapExcel.png");
        ...
        ImageIcon img_btn_XuatExcel = new ImageIcon("src//main//java//pic//icon//buttonXuatExcel.png");
        ...
        ImageIcon img_btn_Luu = new ImageIcon("src//main//java//pic//icon//buttonLuu.png");
